...
<div role="document" class="page">
  ...
  <div class="row margin-bottom-2 padding-top-2" data-equalizer>  
    <div class="small-5 columns padding-0 logo-height" data-equalizer-watch>
  ...
  <header role="banner" class="l-header row">
    ...
    <?php if ($top_bar): ?>
      ...
      <?php endif; ?>
        <nav class="top-bar  large-centered large-10 columns" data-topbar <?php print $top_bar_options; ?>>
          <ul class="title-area">
